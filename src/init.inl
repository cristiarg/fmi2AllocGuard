  ...
  fmi2_guarded_bookkeeping[ 1 ].in_use          = false;
  ...
  fmi2_guarded_bookkeeping[ 2 ].in_use          = false;
  ...
  fmi2_guarded_bookkeeping[ 3 ].in_use          = false;
  ...
  fmi2_guarded_bookkeeping[ 4 ].in_use          = false;
  ...
  fmi2_guarded_bookkeeping[ 5 ].in_use          = false;
  ...
  fmi2_guarded_bookkeeping[ 6 ].in_use          = false;
  ...
  fmi2_guarded_bookkeeping[ 7 ].in_use          = false;
  ...
  fmi2_guarded_bookkeeping[ 8 ].in_use          = false;
  ...
  fmi2_guarded_bookkeeping[ 9 ].in_use          = false;
  ...
  fmi2_guarded_bookkeeping[ 10 ].in_use          = false;
